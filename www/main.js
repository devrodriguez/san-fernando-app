...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.getLocalOrderDetail = function (orderId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            console.log(orderId);
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.deleteProducts = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.conn.executeSql('DELETE FROM Products', [])
                .then(function (data) {
                resolve(data);
            })
                .catch(function (err) {
    ...
    ProductService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"], _ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_2__["SQLite"]])
    ], ProductService);
