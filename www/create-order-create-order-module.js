                    ...
                    case 0: return [4 /*yield*/, this.productService.getProducts().subscribe(function (products) {
                            _this.productService.deleteProducts()
                                ...
                                products.forEach(function (product) {
                                    _this.productService.addProduct(new src_models_product_model__WEBPACK_IMPORTED_MODULE_6__["Product"](product.id, product.name, product.code, product.description, product.price, product.img_url));
                                });
                            })
                                .catch(function (err) {
                                console.log(err);
